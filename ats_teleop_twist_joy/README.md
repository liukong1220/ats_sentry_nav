# ats_teleop_twist_joy

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Build and Test](https://github.com/SMBU-PolarBear-Robotics-Team/ats_teleop_twist_joy/actions/workflows/ci.yml/badge.svg)](https://github.com/SMBU-PolarBear-Robotics-Team/ats_teleop_twist_joy/actions/workflows/ci.yml/badge.svg)
...
- `robot_base_frame (string, default: 'ats_teleop_twist_joy')`
...
```zsh
git clone https://github.com/SMBU-PolarBear-Robotics-Team/ats_teleop_twist_joy.git
```
...
````bash
ros2 launch ats_teleop_twist_joy ats_teleop_twist_joy_launch.py joy_config:='xbox'
````
