...
#ifndef ATS_ROG_MAP_ADAPTER__TEST_FAULT_AUTHORIZATION_HPP_
#define ATS_ROG_MAP_ADAPTER__TEST_FAULT_AUTHORIZATION_HPP_
...
#endif  // ATS_ROG_MAP_ADAPTER__TEST_FAULT_AUTHORIZATION_HPP_
