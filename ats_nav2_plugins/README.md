...
[![Build and Test](https://github.com/SMBU-PolarBear-Robotics-Team/ats_nav2_plugins/actions/workflows/ci.yml/badge.svg)](https://github.com/SMBU-PolarBear-Robotics-Team/ats_nav2_plugins/actions/workflows/ci.yml)
...
`ats_nav2_plugins` 是一个用于扩展 `Navigation2`（Nav2）框架的插件库，当前提供提供了一些额外的行为逻辑和代价地图层以增强机器人在导航过程中灵活性。
...
ros__parameters:
   ...
   backup:
      plugin: "ats_nav2_behaviors/BackUpFreeSpace"
   drive_on_heading:
   ...
   # params for ats_nav2_behaviors/BackUpFreeSpace
   robot_radius: 0.2
   max_radius: 3.5
